...
import com.elife.easy.recycler.divider.SpacingGridItemDecoration;
...
public class FroumViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
	...
	public FroumViewHolder(View view, List<ForumModel> forumList) {
		super(view);
...
//	        animator.setDuration(2000).start();
			...
			mForumList.get(mPosition).setLikeCount(mForumList.get(mPosition).getLikeCount() + 1);
			mLikeCountText.setText(mForumList.get(mPosition).getLikeCount() + "");
			break;
		}
	}
